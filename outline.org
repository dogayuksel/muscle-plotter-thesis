...
*** Interactive Text Books
    \app{} interactions require some input from the user side, in order to determine the domain and configure the output. Predesign worksheets can be effective introduction to train to user such domains.
